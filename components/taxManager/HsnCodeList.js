            ...
            <View style={styles.cardHeader}>
                <View style={styles.headerLeft}>
                    ...
                    <View style={styles.titleWrapper}>
                        <Text style={styles.nameText}>{code}</Text>
                        <Text style={styles.subtitleText}>{subCodeLabel}</Text>
                    </View>
                </View>
            ...
            <View style={styles.infoRow}>
                <View style={styles.infoItem}>
                    ...
                    <View style={styles.codeBadge}>
                        <Text style={styles.codeBadgeText}>{productType}</Text>
                    </View>
                </View>
                <View style={[styles.infoItem, { alignItems: "center" }]}>
                    <Text style={styles.label}>DEFAULT SLAB</Text>
                    <Text style={styles.valueText}>{defaultSlab}</Text>
                </View>
...
const HsnCodeList = ({ onChange = () => {} }) => {
    const hsnData = [
        {
            code: "8517",
            subCodeLabel: "Electronics",
            description: "Telecommunication equipment",
            productType: "5%",
            defaultSlab: "Electronics",
            status: "ACTIVE",
            isActive: true,
        },
        {
            code: "3304",
            subCodeLabel: "Cosmetics",
            description: "Beauty or make-up preparations",
            productType: "12%",
            defaultSlab: "Cosmetics",
            status: "ACTIVE",
            isActive: false,
        },
        {
            code: "6109",
            subCodeLabel: "Apparel",
        ...
        {
            code: "8516",
            subCodeLabel: "Food Grains",
            description: "Electric instantaneous storage water heaters",
            productType: "12%",
            defaultSlab: "Appliances",
            status: "ACTIVE",
            isActive: false,
        },
    ];
