            ...
            <View style={{ flex: 1, backgroundColor: "#FAFAFA" }}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{ marginHorizontal: Sizes.fixPadding + 5.0 }}>
                        ...
                        <TouchableOpacity
                            onPress={() =>
                                props.navigation.push("TaxManagment")
                            }
                        >
                            <Text
                                style={{
                            ...
                            >
                                {getLocalizedString("Tax Manager")}
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() =>
                                props.navigation.push("InventoryHub")
                            }
                        >
                            <Text
                                style={{
                            ...
                            >
                                {getLocalizedString("Inventory Hub")}
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() =>
                                props.navigation.push("ComplianceHub")
                            }
                        >
                            <Text
                                style={{
                            ...
                            >
                                {getLocalizedString("Compliance Hub")}
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() => props.navigation.push("ShippingHub")}
                        >
                            <Text
                                style={{
                                    marginVertical: Sizes.fixPadding - 5.0,
                            ...
                            >
                                {getLocalizedString("Shipping Hub")}
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() =>
                                props.navigation.push("Manufacturers")
                            }
                        >
                            <Text
                                style={{
                            ...
                            >
                                {getLocalizedString("Manufacturers")}
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() => props.navigation.push("AllMaster")}
                        >
                            <Text
                                style={{
                                    marginVertical: Sizes.fixPadding - 5.0,
                            ...
                            >
                                {getLocalizedString("Master")}
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() => props.navigation.push("OrderHub")}
                        >
                            <Text
                                style={{
                                    marginVertical: Sizes.fixPadding - 5.0,
