...
const CourierPartnersHeader = ({ search, onChange = () => {} }) => {
    return (
        <View style={styles.container}>
            <View style={styles.textSection}>
                {/* <Text style={styles.titleText}>Shipping Zones</Text> */}
                <Text style={styles.descriptionText}>
                    Register courier partners, service types, COD & insurance.
                    Manage API credentials and serviceability.
                </Text>
            </View>
...
export default CourierPartnersHeader;
