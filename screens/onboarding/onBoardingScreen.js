...
const quotes = [
    ...
    },
    {
        ...
        title: "Beautiful UI",
        descriptions:
            "LetsMeatz is a Beautiful and Perfect UI for Fashion Store.",
    },
    {
    ...
    return (
        ...
        >
            ...
            >
                <TouchableOpacity
                    onPress={
                        index == 2 ? () => navigation.push("Login") : onPress
                    }
                >
                    <Animated.View
                        style={[
