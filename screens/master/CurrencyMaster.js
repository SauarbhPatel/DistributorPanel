...
import CreateCurrencyMaster from "../../components/form/CreateCurrencyMaster";

const CurrencyMaster = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: Colors.bodyColor }}>
            <CommonHeader
                ...
                subTitle={
                    "Manage supported currencies and exchange rates relative to the base currency"
                }
        ...
        <View style={styles.card}>
            ...
            <View style={styles.detailsContainer}>
                ...
                <View style={styles.detailRow}>
                    ...
                    <View style={styles.infoColumn}>
                        <Text style={styles.detailLabel}>Rate to Base</Text>
                        <Text style={styles.detailValue}>
                            {item?.rate || "22.65"}
                        </Text>
                    </View>
