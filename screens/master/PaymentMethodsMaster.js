...
import CreatePaymentMethodsMaster from "../../components/form/CreatePaymentMethodsMaster";

const PaymentMethodsMaster = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: Colors.bodyColor }}>
            <CommonHeader
                ...
                subTitle={
                    "Manage accepted payment methods and optional transaction fees for checkout and invoices"
                }
